  ...
  grunt.initConfig({
    ...
    connect:{
      ...
      options: {
        ...
        livereload: 35741  //声明给 watch 监听的端口
      },
      server: {
        options: {
    ...
    less: {
        task1:{
            ...
            files: {
              "webapp/style/css/pc.css":"webapp/style/less/pc.less",
              "webapp/style/css/phone.css":"webapp/style/less/phone.less"
            }
        }
    },
    cssmin:{
